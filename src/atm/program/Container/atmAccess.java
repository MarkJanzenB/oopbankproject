...
public atmAccess(UserAccount user) {
    initComponents();
    initComponentsListeners();
    atmInputPIN.setUser(user);
    atmInputUID.setUser(user);
    ...
    private void initComponents() {
        ...
        atmInputUID = new atm.Components.atmInputUID();
        atmInputPIN = new atm.Components.atmInputPIN();
        ...
        atmInputUID.setMaximumSize(new java.awt.Dimension(1033, 625));
        atmInputUID.setMinimumSize(new java.awt.Dimension(1033, 625));
        atmInputUID.setPreferredSize(new java.awt.Dimension(1033, 625));
        jTabbedPane1.addTab("tab1", atmInputUID);
        jTabbedPane1.addTab("tab2", atmInputPIN);
      ...
      StartBTN = atmInputUID.getStartBTN();
      ...
      DoneBTN = new JButton();
      DoneBTN = atmInputPIN.getDoneBTN();
    ...
    private atm.Components.atmInputPIN atmInputPIN;
    private atm.Components.atmInputUID atmInputUID;
